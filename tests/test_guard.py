...
BLOCK = [
    ...
    "python -m ops.session --resume",
    "python -m ops.session --cashflow -2000 withdrawal",
    "echo $(gh pr merge 1)",
    'echo "`gh pr merge 1`"',
    "true; gh pr merge 1",
]
ALLOW = [
    ...
    "python -m ingestion",
    "python -m ops.session --dry-run",
    "python -m harness.run strategies/H-002 coins=3 lookback_d=30",
    "python -m ingestion.binance_history --metrics",
